...
class AdapterKeranjang (var activity: Activity, var data: ArrayList<Model>, var listener: Listeners) : RecyclerView.Adapter<AdapterKeranjang.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.tvNama.text = model.name
        holder.tvHarga.text = Helper().gantiRupiah(harga * model.jumlah)

        var jumlah = data[position].jumlah
        holder.tvJumlah.text = jumlah.toString()

        holder.checkBox.isChecked = model.selected
